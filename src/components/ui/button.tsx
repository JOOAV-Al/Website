  ...
  "inline-flex items-center justify-center gap-2  cursor-pointer whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-app-secondary text-[#FEFAEB] text-lg hover:bg-app-secondary/80 focus-visible:ring-app-secondary/20 dark:focus-visible:ring-app-secondary/40 dark:bg-app-secondary/60",
        primary: "bg-app-primary text-white text-lg hover:bg-app-primary/80 focus-visible:ring-app-primary/20 dark:focus-visible:ring-app-primary/40 dark:bg-app-primary/60",
        accent:
          "bg-white text-app-primary text-lg",
        destructive:
      ...
      size: {
        ...
        main: "h-12 px-6 py-3 has-[>svg]:px-3 rounded-full",
